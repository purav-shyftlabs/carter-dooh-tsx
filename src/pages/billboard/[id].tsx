...
import ScreenDetails from '@/modules/billboard/components/screen-details.component';
import { NextPageWithLayout } from '@/types/common';

const ScreenDetailsPage: NextPageWithLayout = () => {
...
ScreenDetailsPage.getLayout = (page: React.ReactNode) => (
